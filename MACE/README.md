...
## Contents
- [\[CVPR 2024\] MACE: Mass Concept Erasure in Diffusion Models](#cvpr-2024-mace-mass-concept-erasure-in-diffusion-models)
  - [Contents](#contents)
  - [Setup](#setup)
  ...
  - [Sampling from the Finetuned Model](#sampling-from-the-finetuned-model)
...
pip install -e ./recognize-anything/ # error occured when installing
```
...
```
NCCL_P2P_DISABLE=1 NCCL_IB_DISABLE=1 CUDA_VISIBLE_DEVICES=0 python training.py configs/object/erase_ship.yaml
...
CUDA_VISIBLE_DEVICES=0 python inference.py \
          --num_images 3 \
          --prompt 'a photo of a ship' \
          --model_path saved_model/LoRA_fusion_model \
          --save_path evaluation_folder/ship
```
...
NCCL_P2P_DISABLE=1 NCCL_IB_DISABLE=1 CUDA_VISIBLE_DEVICES=0 python src/sample_images_from_csv.py \
          ...
          --save_path evaluation_folder/imagenette_v1/imagenette \
          --model_name saved_model/LoRA_fusion_model_imagenette_v1 \
          --step 1
```
